...
<article>
<h1 class="text-align">쇼핑몰 회원 등록</h1>
<form method="get" action="Insert">
<table>
<tr><td class="text-align">회원번호(자동발생)</td><td><input type="text" name="custno" value="<%=request.getAttribute("custno") %>"/></td></tr>
...
<tr><td class="text-align" colspan="2"><input type="submit" value="등록"/>&nbsp;&nbsp;<input type="button" onclick="location.href='Select'" value="조회"/></td></tr>
</table>
</form>
